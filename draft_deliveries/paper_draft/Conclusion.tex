...
This work compared Krylov and UCCSD as non-variational basis generators for
...
loop. The main numerical result is that Krylov reaches chemical accuracy with a
...
does not translate into a simple hardware advantage. Krylov basis states are
...
cheap. The resulting picture is therefore a genuine tradeoff: Krylov is favored
...
benchmark, Krylov is the more powerful basis family at the algorithmic level,
